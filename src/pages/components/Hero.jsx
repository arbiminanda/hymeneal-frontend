...
const Hero = () => {
    return(
        <div className="h-screen bg-cover flex items-center text-center justify-center max-h-[800px] mx-auto hero" id="hero" style={{
            ...
            <div className="p-4">
                <p className="md:text-3xl font-bold p-2 uppercase mb-5">Hello, you are invited to attend our hymeneal</p>
                <Typed 
                    ...
                    loop
                />
                <p className="mt-5 md:text-3xl sm:text-2xl text-xl">SomeDay, DD Month YYYY</p>
                <p className="mt-5 md:text-4xl sm:text-3xl text-xl font-bold">SomeWhere</p>
            </div>
        </div>
    )
}
